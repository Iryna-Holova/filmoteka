      ...
      const movieCardMarkup = movies
        .map(({ title, poster_path, release_date, genre_ids, id }) => {
          ...
          if (poster_path) { 
            ...
            poster = '../images/no-poster.webp';
          }
            return `<li class="film-list__item" data-id="${id}">
                    <div class="film-list__poster">
                        <img src="${poster}" loading=lazy alt="${title} poster" class="film-list__img" onerror="this.onerror=null;this.src='https://bflix.biz/no-poster.png'">
